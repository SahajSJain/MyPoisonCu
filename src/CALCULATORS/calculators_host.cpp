// CALCULATORS/calculate_boundary_values.cu
// Apply boundary conditions to field ghost points
// Handles Dirichlet, Neumann, and Periodic boundary conditions
...
void calculate_residual(Field<real_t> &u, Field<real_t> &rhs, Operator &op, Field<real_t> &result)
{
  int i, j;
...
void calculate_residual_norm(Field<real_t> &u, Field<real_t> &rhs, Operator &op, 
...
void calculate_opinv_dot_product(Field<real_t> &u1, Field<real_t> &u2, Operator &op, real_t &result)
{
  int i, j;
...
void calculate_matrix_vector(Field<real_t> &phi, Operator &op, Field<real_t> &result)
{
  int i, j;
  int N = op.N;   // number of internal grid points (should match phi and result)
  int Nb = op.Nb; // number of grid points including boundaries
...
void calculate_boundary_values(Solver &solver)
{
...
// Overloaded version for applying boundary conditions to any field
void calculate_boundary_values(Field<real_t> &phi, Solver &solver)
{
  // This function applies boundary conditions to ghost points 
  int i, j;
  int N = solver.N;   // number of internal grid points
...
void calculate_vector_scalar_addition(real_t alpha, Field<real_t> &phi, real_t beta, Field<real_t> &result)
{
  int i, j;
...
void calculate_vector_linear_combination(real_t alpha1, real_t alpha2, Field<real_t> &phi1, Field<real_t> &phi2, Field<real_t> &result)
{
  int i, j;
  int N = result.N;   // number of internal grid points (should match phi and result)
  int Nb = result.Nb; // number of grid points including boundaries
...
void calculate_vector_addition(real_t alpha1, real_t alpha2, Field<real_t> &phi1, Field<real_t> &phi2, Field<real_t> &result)
{
  int i, j;
  int N = result.N;   // number of internal grid points (should match phi and result)
  int Nb = result.Nb; // number of grid points including boundaries

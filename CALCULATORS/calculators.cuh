...
void calculate_dot_product_device(Field<real_t> &u1, Field<real_t> &u2, real_t &result, int numThreads, int numBlocks);
void calculate_opinv_dot_product_device(Field<real_t> &u1, Field<real_t> &u2, Operator &op, real_t &result, int numThreads, int numBlocks);
